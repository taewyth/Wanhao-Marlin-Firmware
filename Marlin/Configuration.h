...
// CHOIX MODELE D12 (Ne pas oublier de changer le type de carte dans platformio.ini)
...
#define STRING_CONFIG_H_AUTHOR "(Wanhao, 230 1.2)" // Who made the changes.
#endif

#if ENABLED(D12_230_v1_3)
#define STRING_CONFIG_H_AUTHOR "(Wanhao, 230 1.3)" // Who made the changes.
#endif
 
#if ENABLED(D12_500_Pro)
#define STRING_CONFIG_H_AUTHOR "(Wanhao, 500 Pro Max)" // Who made the changes.
#endif

#if ENABLED(D12_300_Pro)
#define STRING_CONFIG_H_AUTHOR "(Wanhao, 300 Pro Max)" // Who made the changes.
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  22.77
    #define DEFAULT_Ki   1.36
    #define DEFAULT_Kd 95.62
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #if ENABLED(D12_500_Pro)
    #define DEFAULT_bedKp 99.83
    #define DEFAULT_bedKi 17.58
    #define DEFAULT_bedKd 378.03
  #endif

  #if ENABLED(D12_300_Pro)
    #define DEFAULT_bedKp 50.05
    #define DEFAULT_bedKi 8.45
    #define DEFAULT_bedKd 197.52
  #endif

  #if ENABLED(D12_230_v1_3)
     #define DEFAULT_bedKp 92.32
     #define DEFAULT_bedKi 17.62
     #define DEFAULT_bedKd 120.95
  #endif
...
#define DEFAULT_MAX_ACCELERATION      { 300, 300, 100, 2000 }
