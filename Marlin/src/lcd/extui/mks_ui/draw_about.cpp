...
extern lv_group_t *g;
static lv_obj_t *scr;
static lv_obj_t *fw_type, *date_type, *board;
...
void lv_draw_about() {
  ...
  fw_type = lv_label_create(scr, "Marlin 2.1.1");
  lv_obj_align(fw_type, nullptr, LV_ALIGN_CENTER, 0, -30);
  
  date_type = lv_label_create(scr, "17/10/2022");
  lv_obj_align(date_type, nullptr, LV_ALIGN_CENTER, 0, -50);
